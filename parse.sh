...
echo "Source,Destination,Port,Connectivity"> result.csv # This file will hold the results information 
while IFS="_" read -r source destination ports <&3; # Use of a separate standard input stream, target file descriptor (3), for the "server.list" file 
do	
	for port in $ports 
	do 
